...
class FrmConsultaDNI:
    def __init__(self, root, restart_callback):
        ...
        self.lblHora = Label(root, text="", bg='#e6ede9', font=('Arial', 12, 'bold'))
        self.lblHora.grid(row=9, column=0, columnspan=2, pady=10)
    ...
    def actualizar_hora(self):
        ...
        self.lblHora.config(text=ahora)
        self.root.after(1000, self.actualizar_hora)  # Schedule the function to be called again after 1 second      
